public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < reverseClass.length; i++) {
            System.out.println(reverseClass[i].reversedString);
        }
        ...
        System.out.println(">......................<");
        System.out.println(new ReverseString().reversedFullString());
       // System.out.println(new ReverseString().reversedString);
    }
}